    ...
    <div className="min-h-screen bg-[#050505] px-6 py-10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        {walletAccounts.length > 0 && (
          <div className="flex items-center justify-between p-6 mb-10 rounded-2xl bg-gradient-to-br from-pink-500/8 to-purple-500/5 border border-pink-500/15 overflow-hidden relative">
            <div
